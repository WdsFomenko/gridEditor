...
myApp.controller('bookCtrl',function($scope, $http){
  ...
  $scope.bookCtrlNs.messageResponse = 'Error of connection with a database of subscribers !';
  ...
  $scope.bookCtrlNs.getCustomers = function(){
      $http.get($scope.bookCtrlNs.configDbUrl)
          .success(function(customers) {
              ...
              $scope.bookCtrlNs.showMessage(true,'The list of users is successfully loaded!');
          }).error(function(err) {
              $scope.bookCtrlNs.showMessage(false,'Error of connection with REST service!');
          });
  };
  ...
  $scope.bookCtrlNs.setCustomers = function(){
      if($scope.bookCtrlNs.idf != ''){
          ...
          $http(req)
              .success(function(customers) {
                  $scope.bookCtrlNs.showMessage(true,'Record about the subscriber is successfully created!');
              }).error(function(err) {
                  $scope.bookCtrlNs.showMessage(false,'Error of creation of record of the subscriber!');
              });
      }
  };
  ...
  $scope.bookCtrlNs.deleteCustomers = function(){
      if($scope.bookCtrlNs.idf != ''){
          ...
          $http(req)
              .success(function(customers) {
                  $scope.bookCtrlNs.showMessage(true,'Record about the subscriber is successfully removed!');
              }).error(function(err) {
                  $scope.bookCtrlNs.showMessage(false,'Error of removal of record about the subscriber!');
              });
  ...
  $scope.bookCtrlNs.updateCustomers = function(){
      if($scope.bookCtrlNs.idf != ''){
          ...
          $http(req)
              .success(function(customers) {
                  $scope.bookCtrlNs.showMessage(true,'Record about the subscriber is successfully updated!');
              }).error(function(err) {
                  $scope.bookCtrlNs.showMessage(false,'Error of removal of update about the subscriber!');
              });
      }
  };
